...
def play():
    comp_choise = ['yes', 'no'] * 5 #псевдологика :D
    ...
    while True:
        ...
        if 'no' in my_quest and 'no' in quest:
            ...
            if my_count > 21 and comp_count > my_count:
                print('Вы оказались ближе к 21, Вы победили\n')
            if my_count <=21 and comp_count > 21:
                print('Компьютер набрал больше 21, Вы победили\n')
            if my_count < comp_count and comp_count <= 21:
                print('Вы проиграли\n')
            if my_count > comp_count and my_count <= 21:
                print('Вы победили \n')
            if my_count <= 21 and comp_count > 21:
                print('Вы победили\n')
            print('конец игры\n \n \n')
